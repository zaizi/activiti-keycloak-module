...
public class CustomizeDaoAuthenticationProvider extends DaoAuthenticationProvider {
	 ...
	 *            : UsernamePasswordAuthenticationToken which holds User name
	 *            and Password
	 * @throws AuthenticationException
	 *             : Exception on authentication fail
	 */
	 ...
	 *             : Exception on authentication fail
	 */
	public UserDetails retrieveUserDetails(String username, UsernamePasswordAuthenticationToken authentication)
			throws AuthenticationException {
